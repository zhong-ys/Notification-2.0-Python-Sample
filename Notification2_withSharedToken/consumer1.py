...
devices = ["12345", "23456", "34567", "45678", "56789", "67890"]
subscription_id = []
...
for i in devices:
    ...
    subscription_id.append(subscription_response['id'])
...
def close_handler(ws, close_status_code, close_msg):
    ...
    # Delete subscription
    for i, j in zip(devices, subscription_id):
        subscription_json['source']['id'] = i
        client.delete(
            C8Y_BASEURL + '/notification2/subscriptions/' + j,
            auth = C8Y_AUTH,
        )
...
ws_client = websocket.WebSocketApp(
    C8Y_BASEURL_WEBSOCKET + '/notification2/consumer/?token=' + token_response['token'] + '&consumer=instance1',
